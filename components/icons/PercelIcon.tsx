...
export const PercelIcon2 = ({ color }: { color?: string }) => {
  return (
    <svg
      width="22"
      height="24"
    ...
    >
      <path
        d="M13 22C12.1818 22 11.4002 21.6588 9.83691 20.9764C8.01233 20.18 6.61554 19.5703 5.64648 19H2M13 22C13.8182 22 14.5998 21.6588 16.1631 20.9764C20.0544 19.2779 22 18.4286 22 17V6.5M13 22V11M4 6.5V9.5"
        stroke={color || "#246027"}
        strokeWidth="1.5"
        strokeLinecap="round"
      ...
      />
      <path
        d="M18.1366 4.01562L7.86719 8.98485"
        stroke={color || "#246027"}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
